{ lib, fetchFromGitHub, buildGo124Module, buildNpmPackage, }:
let
  version = "0.8.6-beta";
  ...
  frontend = buildNpmPackage {
    ...
    postPatch = ''
      cp ${./filebrowser-quantum-package-lock.json} package-lock.json
    '';

    sourceRoot = "${src.name}/frontend";
    npmDepsHash = "sha256-SVnj7GXj5U/t5SpUgQ9TwT0ZwhJQIkV+i2jBkWOPIm0=";
