    ...
    extraConfig =
      ...
      concatStrings [
        ''
          ...
          exec-once = swayidle -w timeout 1200 'swaylock -f' timeout 1300 'hyprctl dispatch dpms off' resume 'hyprctl dispatch dpms on' before-sleep 'swaylock -f -c 000000'
          exec-once = gammastep
          dwindle {
            pseudotile = true
            preserve_split = true
